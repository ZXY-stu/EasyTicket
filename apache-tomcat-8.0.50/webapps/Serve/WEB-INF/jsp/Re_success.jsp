    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
				...
				<span>注册成功!</span><p>页面将在<span id="time">5</span>秒后跳转，若未跳转,请点击下方按钮</p>
				  <div class="field field-icon-right">
				<form action="toLogin" method="post" id="fo">
		         <input type="submit" class="button button-block" value="去登陆"></div>
		        </form>	 
				</div>
