...
<script type="text/javascript">
 ...
 function check(){
	  ...
	  if("null"==userName){
		  noLogin.hidden = false;
		  haveLogin.hidden = true;
	  }else{
		
		    noLogin.hidden = true;
		  haveLogin.hidden = false;
		  name.innerHTML=userName+'  ';
	  }
 }
 
 function logout(){
window.location.href='html_5/logout.jsp';
...
<!-- header -->
	<div class="agileits_header">
		...
		<div class="w3l_header_right" id="noLogin"  >
		<ul>
		...
		<div class="w3l_header_right" style="padding-left:50px" id="haveLogin" hidden="true">
		<div>
		<ul>
		<li class="dropdown profile_details_drop">
		<a href="#" class="dropdown-toggle" data-toggle="dropdown">
