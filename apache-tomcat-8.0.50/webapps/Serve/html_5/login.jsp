...
<!-- //for-mobile-apps -->
<link href="html_5/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="html_5/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- font-awesome icons -->
<link href="html_5/css/font-awesome.css" rel="stylesheet" type="text/css" media="all" /> 
<!-- //font-awesome icons -->
<!-- js -->
<script src="html_5/js/jquery-1.11.1.min.js"></script>
<!-- js -->
<link href='//fonts.googleapis.com/css?family=Ubuntu:400,300,300italic,400italic,500,500italic,700,700italic' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
<!-- start-smoth-scrolling -->
<script type="text/javascript" src="html_5/js/move-top.js"></script>
<script type="text/javascript" src="html_5/js/easing.js"></script>
<script type="text/javascript">
	jQuery(document).ready(function($) {
	 ...
	 function check_em(){
	   ...
	   var em_div = document.getElementById("error_msg");
	   if(em.indexOf('@')!=-1 && em.indexOf('.')!=-1)
	   em_div.innerHTML='';
	   else
	   em_div.innerHTML="<font  color='red'>邮箱格式错误</font>";
	 }
				...
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<form action="Register" method="post">
					  ...
					  <div float="right">
					  <input type="password" name="pwd" id="pwd_again" placeholder="Affirm Password" onkeyup="check()" required=" ">
					  </div><div><span id="comfirm_pwd"></span></div>
					  <input type="email" name="email" id="Reg_email" placeholder="Email Address" onkeyup="check_em()" required=" ">
